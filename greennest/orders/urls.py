...
urlpatterns = [
    ...
    path("<int:order_id>/return/<int:item_id>/", views.request_return_item, name="request_return_item"),
    path("<int:order_id>/return/", views.request_return_order, name="request_return_order"),
